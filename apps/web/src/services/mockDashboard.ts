...
const baseDashboard = (): DashboardMock => ({
  ...
  imtoPartners: [
    ...
    {
      id: 'IMTO-005',
      name: 'Wise Payments (UK)',
      country: 'United Kingdom',
      corridor: 'United Kingdom -> Nigeria',
      status: 'active',
      riskRating: 'low',
      integrationMode: 'NETWORK',
      iso20022Ready: true,
      bic: 'WISEGB2LXXX',
      onboardingChannel: 'network',
      creditSla: '90s',
      settlementCurrency: 'GBP / NGN',
      prefundingModel: 'prefunded',
  ...
  networkDirectory: [
    { bic: 'WISEGB2LXXX', institution: 'Wise Payments (UK)', country: 'United Kingdom', corridor: 'United Kingdom -> Nigeria', settlementCurrency: 'GBP / NGN', messagingStandard: 'ISO 20022', network: 'SWIFT', defaultCreditSla: '90s', defaultRiskRating: 'low', adapterProfile: 'swift-iso20022-standard' },
    { bic: 'REMIUS33XXX', institution: 'Remitly Global (US)', country: 'United States', corridor: 'United States -> Nigeria', settlementCurrency: 'USD / NGN', messagingStandard: 'ISO 20022', network: 'SWIFT', defaultCreditSla: '90s', defaultRiskRating: 'low', adapterProfile: 'swift-iso20022-standard' },
    { bic: 'WUNIUS33XXX', institution: 'Western Union (US)', country: 'United States', corridor: 'United States -> Nigeria', settlementCurrency: 'USD / NGN', messagingStandard: 'MT103', network: 'SWIFT', defaultCreditSla: '120s', defaultRiskRating: 'medium', adapterProfile: 'swift-mt103-legacy' },
    { bic: 'LEMFFRP1XXX', institution: 'Lemfi Europe (France)', country: 'France', corridor: 'France -> Nigeria', settlementCurrency: 'EUR / NGN', messagingStandard: 'ISO 20022', network: 'SWIFT', defaultCreditSla: '90s', defaultRiskRating: 'low', adapterProfile: 'swift-iso20022-standard' },
    { bic: 'TAPTAE22XXX', institution: 'Taptap Send (UAE)', country: 'United Arab Emirates', corridor: 'UAE -> Nigeria', settlementCurrency: 'AED / NGN', messagingStandard: 'ISO 20022', network: 'SWIFT', defaultCreditSla: '90s', defaultRiskRating: 'medium', adapterProfile: 'swift-iso20022-standard' },
    { bic: 'MUKUKEN1XXX', institution: 'Mukuru Africa (Kenya)', country: 'Kenya', corridor: 'Kenya -> Nigeria', settlementCurrency: 'KES / NGN', messagingStandard: 'MT103', network: 'SWIFT', defaultCreditSla: '120s', defaultRiskRating: 'medium', adapterProfile: 'swift-mt103-legacy' },
  ],
  complianceHolds: [
