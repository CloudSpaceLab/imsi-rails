...
const baseDashboard = (): DashboardMock => ({
  ...
  summary: {
    ...
    connection: {
      ...
      nextPollIn: 'Provider polling: 15s',
    },
    metrics: [
  ...
  routingContracts: [
    {
      ...
      endpoints: [
        ...
        { name: 'Moniepoint MFB', kind: 'MFB', rail: 'Moniepoint API', reach: '5M accounts', reliability: '97.2%', p95Credit: '2m 44s', openCredits: 0, callbackLag: '44s', settlementLag: '3m', owner: 'NIP monitor', state: 'watch' },
        { name: 'PalmPay wallet', kind: 'Fintech wallet', rail: 'PalmPay API', reach: '25M wallets', reliability: '98.0%', p95Credit: '26s', openCredits: 0, callbackLag: '15s', settlementLag: '2m', owner: 'Inbound Ops', state: 'healthy' },
      ],
    },
    {
      id: 'CON-GR-NG-02',
      ...
      endpoints: [
        ...
        { name: 'Moniepoint MFB', kind: 'MFB', rail: 'Moniepoint API', reach: '5M accounts', reliability: '91.4%', p95Credit: '4m 02s', openCredits: 1, callbackLag: '7m 40s', settlementLag: '6m', owner: 'NIP monitor', state: 'degraded' },
        { name: 'Fairmoney MFB', kind: 'MFB', rail: 'Fairmoney API', reach: '3M accounts', reliability: '95.1%', p95Credit: '3m 30s', openCredits: 1, callbackLag: '1m 18s', settlementLag: '5m', owner: 'Inbound Ops', state: 'watch' },
      ],
    },
    {
      id: 'CON-UK-NG-03',
  ...
  creditLegs: [
    ...
    },
    {
      ...
      evidence: [
        ...
        { label: 'Final credit callback', reference: 'MPT-TRF-55381', status: 'Overdue', owner: 'NIP monitor', state: 'degraded' },
      ],
      timeline: [
    ...
    },
    {
      ...
      evidence: [
        ...
        { label: 'Suspense ledger hold', reference: 'SUSP-7742', status: 'Open', owner: 'Inbound Ops', state: 'watch' },
      ...
      timeline: [
        ...
        { label: 'Reversal to partner', owner: 'Inbound Ops', status: 'current', time: '14:12:00', note: 'Awaiting maker-checker on reversal instruction' },
      ],
    },
    {
      reference: 'CRD-90255',
  ...
  inboundSla: [
    ...
    { contractId: 'CON-GR-NG-02', partner: 'Hellenic Remit (Greece)', corridor: 'Greece -> Nigeria', creditSla: '120s', p95Credit: '4m 02s', breachRate: '5.2%', agingBreaches: 6, valueAtRisk: 'NGN 2.44M', oldestBreach: '8m 12s', breachReason: 'Moniepoint callback lag', owner: 'NIP monitor', recommendedAction: 'Escalate endpoint callback lag at 10m aging', state: 'degraded', trend: '+2.1% vs last week' },
  ...
  outcomeEvidence: [
    ...
    { instructionReference: 'INF-10003', type: 'partner_callback', label: 'Final credit callback', reference: 'MPT-TRF-55381', status: 'Overdue', owner: 'NIP monitor', state: 'watch' },
    { instructionReference: 'INF-10005', type: 'rail_session', label: 'NIP accepted session', reference: 'NIP-TRF-88437', status: 'Cooldown before first requery', owner: 'NIP monitor', state: 'watch' },
    ...
    { instructionReference: 'INF-10004', type: 'operator_note', label: 'Reversal maker note', reference: 'REV-ISW-55092', status: 'Pending checker', owner: 'Inbound Ops', state: 'watch' },
  ],
  remediationCases: [
    {
      id: 'CASE-INF-10002',
  ...
  routePenalties: [
    ...
    { route: 'Moniepoint final leg', rail: 'Moniepoint', destinationBank: 'MFBs and wallets', p95CreditTime: '4m 02s', timeoutRate: '5.2%', lateSuccessRate: '1.1%', openCases: 2, penaltyScore: 24, penaltyReason: 'Callback lag and manual evidence burden.', trafficSplit: '18% of eligible external traffic', fallbackOrder: 'NIP, Interswitch', state: 'watch' },
    { route: 'Interswitch final leg', rail: 'Interswitch', destinationBank: 'External banks', p95CreditTime: '52s', timeoutRate: '0.9%', lateSuccessRate: '0.1%', openCases: 1, penaltyScore: 12, penaltyReason: 'One failed-safe reversal waiting maker-checker.', trafficSplit: '12% of eligible external traffic', fallbackOrder: 'NIP, Moniepoint', state: 'watch' },
  ],
  routeDecisions: [
    {
      instructionReference: 'INF-10002',
  ...
  routeHealthWindows: [
    ...
    { route: 'Moniepoint final leg', sourceTable: 'route_health_windows', rail: 'Moniepoint', window: '14:00-14:15', submittedCount: 74, creditedCount: 70, failedCount: 1, timeoutCount: 3, openCases: 1, p95CreditTime: '3m 28s', lateSuccessCount: 1, state: 'watch' },
    { route: 'Moniepoint final leg', sourceTable: 'route_health_windows', rail: 'Moniepoint', window: '14:15-14:30', submittedCount: 91, creditedCount: 84, failedCount: 1, timeoutCount: 5, openCases: 2, p95CreditTime: '4m 02s', lateSuccessCount: 2, state: 'watch' },
  ...
  integrationHealth: [
    ...
    { id: 'provider-moniepoint-callback', sourceTable: 'api_health_windows', serviceName: 'Moniepoint callback listener', endpoint: '/callbacks/moniepoint', provider: 'Moniepoint', successRate: '96.1%', timeoutRate: '5.2%', p95Latency: '1.9s', polling: 'Replay every 3m', callbackStatus: 'Callback overdue', lastSuccessAt: '14:26:46 UTC', nextAction: 'Run callback replay for active cases.', state: 'watch' },
