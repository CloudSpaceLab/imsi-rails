...
export const fxCostBoard: FxCostBoard = {
  corridor: 'EU -> Nigeria',
  pair: 'EUR/NGN',
  window: '15 min',
  ...
  rateAlert: 'Remitly rate is 22 min old. Do not send fresh EUR/NGN traffic there.',
  decision: 'Ria is cheapest, but the route is degraded. Thunes costs +0.08% and is healthy, so it stays recommended.',
  routes: [
    {
      provider: 'Thunes',
      route: 'Thunes -> NIP',
